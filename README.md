...
I'm an undergraduate building projects across **AI agents, data science, web apps, and computational neuroscience**. I use GitHub to document deployable demos, reproducible notebooks, and course/research projects as I grow toward software, data, and AI-focused internships.

## What I'm focused on

- AI-assisted programming, local LLM workflows, and agent-style automation
- Reproducible data science with Python, Jupyter, Quarto, GitHub Pages, and containers
...
I'm especially interested in connecting AI agents with learning systems, research workflows, and neuroscience/data-science tooling. My current goal is to turn coursework and prototypes into clearer portfolio artifacts: strong READMEs, reproducible run steps, and visible demos/results.

## Contact

- GitHub: https://github.com/rola2005-klc
